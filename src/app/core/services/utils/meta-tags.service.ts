...
export class MetaTagsService {
  ...
  defaultMetaTags(){
    this.addTitle('Red Social - Mi Mascota - Foros para perros perdidos y más. ');
    this.addDescriptionMetaTag('Red Social de Mascotas. Publica tus animales en distintos foros segun tu necesidad. Foros: Me Perdi, Busco Pareja, Adoptar');
  }
}
